...
export const profile: Profile = {
  ...
  companyAbout: [
    ...
    "Our work spans fintech, education, and creative industries, with engagements including Imara Capital, Sam Creative Design School, and Sam Creative Graphics.",
  ],
  about: [
