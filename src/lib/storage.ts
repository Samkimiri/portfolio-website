...
// Reuses the same public bucket as project screenshots (under a distinct
// path prefix) rather than provisioning a second bucket + RLS policy set
// for what's still just "an admin-uploaded image."
